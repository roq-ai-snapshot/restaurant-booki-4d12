...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'menu.update': { roles: ['owner'], key: 'menu-item-status-update', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'table.create': { roles: ['owner'], key: 'table-added', tenantPath: ['restaurant', 'table'], userPath: [] },
};
